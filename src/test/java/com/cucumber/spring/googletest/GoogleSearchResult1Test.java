...
import com.cucumber.spring.config.FakerConfig;
...
public class GoogleSearchResult1Test extends SpringSeleniumTestNG {
    ...
    public void searchGoogleKeyword() throws IOException {
        ...
        this.googlePage.getSearchPage().search("selenium");
